...
void gerente::abrir_conta(banco& bank)
{
	std::cout<< std::endl;
...
void gerente::consultar_conta(banco& bank)
{
	std::cout << std::endl;
...
void gerente::atualizar_conta(banco& bank)
{
	std::cout << std::endl;
...
void gerente::fechar_conta(banco& bank)
{
	std::cout << std::endl;
...
void gerente::listar_contas(banco& bank)
{
...
void gerente::listar_contas_correntista(banco& bank)
{
	std::cout << std::endl;
	auto nome = console::read<std::string>("Digite o Nome da Pessoa: ");
	auto cpf_cnpj = console::readCpf_Cnpj();

...
namespace usuario
{
	void depositar(banco& bank, std::shared_ptr<conta const> c)
	{
		std::cout<< std::endl;
		double d;
		while(1){
	...
	void retirar(banco& bank, std::shared_ptr<conta const> c)
	{
		std::cout<< std::endl;
		double r;
		while(1){
	...
	void transferir(banco& bank, std::shared_ptr<conta const> c)
	{
		std::cout<< std::endl;
		while(1){
			std::string n;
	...
	void saldo(banco& bank, std::shared_ptr<conta const> c)
	{
		std::cout<< c->get_saldo() << std::endl;
	}
	void extrato(banco& bank, std::shared_ptr<conta const> c)
	{
		c->extrato();
	}
}
